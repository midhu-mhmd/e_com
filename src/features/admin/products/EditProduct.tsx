    ...
    if (fetchError) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center gap-4 bg-[#FDFDFD]">
                <p className="text-cyan-500 font-bold">{fetchError}</p>
                <button
...
const EditProductForm: React.FC<EditProductFormProps> = ({ dto, productId }) => {
    ...
    return (
        <div className="min-h-screen bg-[#FDFDFD] p-6 md:p-12 space-y-8 animate-in slide-in-from-right duration-500">
            ...
            {error && (
                <div className="max-w-4xl mx-auto bg-cyan-50 text-cyan-600 p-4 rounded-xl text-sm font-medium border border-cyan-100">
                    {error}
                </div>
            )}
                ...
                <section className="bg-white border border-[#EEEEEE] rounded-2xl p-6 shadow-sm space-y-6">
                    ...
                    <div className="grid gap-6">
                        <div className="space-y-2">
                            ...
                            />
                            {errors.name && <p className="text-cyan-500 text-[10px] font-bold">{errors.name.message}</p>}
                        </div>
                        <div className="space-y-2">
                            ...
                            />
                            {errors.description && <p className="text-cyan-500 text-[10px] font-bold">{errors.description.message}</p>}
                        </div>
                    </div>
                </section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 bg-[#FAFAFA] border-none rounded-xl text-sm font-medium focus:ring-2 focus:ring-black outline-none transition-all"
                            />
                            {errors.category && <p className="text-cyan-500 text-[10px] font-bold">{errors.category.message}</p>}
                        </div>
                        <div className="space-y-2">
